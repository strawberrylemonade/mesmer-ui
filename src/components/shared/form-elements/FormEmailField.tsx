...
const FormEmailField: React.FC<FormEmailFieldProps> = ({ name, initial, hint, onChange }) => {
  ...
  return <div className="sm:grid sm:grid-cols-3 mt-4 sm:gap-4 sm:items-start">
    ...
    <div className="mt-1 sm:mt-0 sm:col-span-2">
      <div className="rounded-md shadow-sm">
        <input type="email" onChange={handleChange} id={name} value={fieldState} className="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
      </div>
